...
- [#1133](https://github.com/lmk123/crx-selection-translate/issues/1133) Firefox 的[扩展弹出页](popup.mdx)在翻译长文本时会出现横向滚动条，而且偶尔会无法纵向滚动。由于 Firefox 似乎没法调试扩展弹出页的代码，所以目前我没办法解决这个问题。建议使用独立翻译窗口代替扩展弹出页，因为独立翻译窗口可以调整宽度，将宽度调宽一点就不会出现滚动条了。
