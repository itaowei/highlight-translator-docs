...
划词翻译支持 9 个国内外热门的翻译服务，包括但不限于谷歌翻译、DeepL、百度、有道等，且支持[百度翻译专业版](https://api.fanyi.baidu.com/product/121)和[阿里翻译专业版](https://help.aliyun.com/document_detail/158291.html)，能让你在网络文学、金融财经、科技电子、水利机械、生物医药、电商、社交等专业领域下获取更专业的翻译结果。

除此之外，划词翻译还支持以下功能：

- [网页全文翻译](page.md)：使用任意翻译服务一次性翻译整个网页内的文本，支持双语对照、单独显示原文 / 译文。
- [截图 / 图片](screenshot.md)：截取网页或者读取剪切板里的图片并显示翻译结果。
