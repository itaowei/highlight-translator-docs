...
如果你实在不想自己申请密钥，那么你可以购买[翻译积分](services/tp.md)来使用这些服务，这其实就是通过划词翻译自己的密钥来访问这些服务，而你购买的翻译积分就是用来支付这些翻译平台的翻译字符费用了，划词翻译仅赚取极少的差价用来维持服务器的运转。
