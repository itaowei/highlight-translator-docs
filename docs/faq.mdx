...
你申请的密钥只会保存在浏览器中，即使开启了数据同步也不会上传。虽然这样一来，你每在一个新的浏览器使用划词翻译时都要重新粘贴一遍密钥，但我认为为了确保你的密钥安全，这是值得的，详细解释可以[查看这条评论](https://github.com/lmk123/crx-selection-translate/issues/1014#issuecomment-828159124)。
