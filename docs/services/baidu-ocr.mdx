...
如果你之前申请过[百度翻译接口](baidu-api.mdx)，那么你已经认证过了。
...
:::note
由于 2021 年 5 月 26 日的调整，百度通用文字识别还需要自行领取免费资源包才有免费额度。操作方式可以参考：[官方文档](https://cloud.baidu.com/doc/OCR/s/fk3h7xu7h#%E9%A2%86%E5%8F%96%E6%96%B9%E5%BC%8F)
:::
