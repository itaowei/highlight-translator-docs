...
- [#1047](https://github.com/lmk123/crx-selection-translate/issues/1047) 现在可以在设置页里将文本框的翻译快捷键由 Ctrl + Enter 修改为 Enter 了。
- [#1109](https://github.com/lmk123/crx-selection-translate/issues/1109) 现在可以在设置页里管理网页全文翻译的翻译服务下拉框选项了，你可以仅保留你常用的翻译服务，方便切换。
- [#1157](https://github.com/lmk123/crx-selection-translate/issues/1157) 现在可以在设置页里管理右键菜单了。
...
- [#1190](https://github.com/lmk123/crx-selection-translate/issues/1190) **修复 DeepL 报”找不到target的语种下拉框“错误的问题。**
