...
- [#979](https://github.com/lmk123/crx-selection-translate/issues/979) 增加一个新的选项：在单独的窗口中打开内置 PDF 阅读器。这个窗口类似于独立翻译窗口，是没有地址栏的，看起来更简洁。
- [#1148](https://github.com/lmk123/crx-selection-translate/issues/1148) 增加一个新的选项，允许用户将点击扩展按钮的行为由弹出 popup 页面改为开启网页全文翻译。
- [#1054](https://github.com/lmk123/crx-selection-translate/issues/1054) 增加了一个新的选项，可以限制划选的文本数量，如果超过这个数量则不触发翻译。
- [#990](https://github.com/lmk123/crx-selection-translate/issues/990) 增加了一个新的选项，允许用户自定义翻译面板上的按钮的显示与隐藏。
- [#1182](https://github.com/lmk123/crx-selection-translate/issues/1182) 给翻译面板增加了打开收藏夹和历史记录的按钮，不过默认是隐藏的，可以通过上面提到的选项显示出来。

#### 功能改进 {#v8-6-2-improve}

- [#1185](https://github.com/lmk123/crx-selection-translate/issues/1185) 网页全文翻译中的译文现在可以编辑了。
...
- [#1047](https://github.com/lmk123/crx-selection-translate/issues/1047) 增加了一个新的选项，可以将文本框的翻译快捷键由 Ctrl + Enter 修改为 Enter。
- [#1109](https://github.com/lmk123/crx-selection-translate/issues/1109) 增加了一个新的选项，允许用户自定义网页全文翻译的翻译服务下拉框选项了，你可以仅保留你常用的翻译服务，方便切换。
- [#1157](https://github.com/lmk123/crx-selection-translate/issues/1157) 增加了一个新的选项，允许用户管理右键菜单了，你可以仅保留你需要的右键菜单。
- [#1174](https://github.com/lmk123/crx-selection-translate/issues/1174) [#977](https://github.com/lmk123/crx-selection-translate/issues/977) 对设置页进行了改版，现在的设置页更整洁了。

#### bug 修复 {#v8-6-1-bug}

- [#1190](https://github.com/lmk123/crx-selection-translate/issues/1190) **修复 DeepL 报”找不到 target 的语种下拉框“错误的问题。**
...
- [#1093](https://github.com/lmk123/crx-selection-translate/issues/1093) 添加将次要目标语种“动态的设置为上次翻译的文本的语种”的功能。[查看说明](guides/talk.mdx#latest-source)
...
- [#1021](https://github.com/lmk123/crx-selection-translate/issues/1021) 独立翻译窗口和扩展按钮弹窗现已支持自动翻译剪切板内的图片，具体使用方法见[这篇介绍](guides/extra.mdx)
...
- 新增[音视频翻译功能](./guides/video.mdx)，可以翻译网页中的视频和音频。
